# Cuboid: olap_sales_time_customer_location
EXTRACT_SQL = """\
SELECT
...
GROUP BY dt.year, dt.quarter, dt.month, dc.customer_type, fs.customer_key, dl.state, dl.city
"""
TARGET_COLUMNS = ['year', 'quarter', 'month', 'customer_type', 'customer_key', 'state', 'city', 'total_quantity', 'total_amount']
TARGET_TABLE   = 'olap_sales_time_customer_location'
