...
GROUP BY dt.year, dt.quarter, dt.month, fs.product_key, dc.customer_type, fs.customer_key, dl.state, dl.city
"""
TARGET_COLUMNS = ['year', 'quarter', 'month', 'product_key', 'customer_type', 'customer_key', 'state', 'city', 'total_quantity', 'total_amount']
TARGET_TABLE   = 'olap_sales_base'
