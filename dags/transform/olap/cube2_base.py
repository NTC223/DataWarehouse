...
GROUP BY dt.year, dt.quarter, dt.month, fi.product_key, fi.store_key, dl.state, dl.city
"""
TARGET_COLUMNS = ['year', 'quarter', 'month', 'product_key', 'store_key', 'state', 'city', 'total_quantity_on_hand']
TARGET_TABLE   = 'olap_inv_base'
