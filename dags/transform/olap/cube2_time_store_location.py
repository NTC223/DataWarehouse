# Cuboid: olap_inv_time_store_location
EXTRACT_SQL = """\
SELECT
    dt.year,
    dt.quarter,
...
GROUP BY dt.year, dt.quarter, dt.month, fi.store_key, dl.state, dl.city
"""
TARGET_COLUMNS = ['year', 'quarter', 'month', 'store_key', 'state', 'city', 'total_quantity_on_hand']
TARGET_TABLE   = 'olap_inv_time_store_location'
