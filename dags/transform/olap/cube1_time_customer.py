# Cuboid: olap_sales_time_customer
EXTRACT_SQL = """\
SELECT
...
GROUP BY dt.year, dt.quarter, dt.month, dc.customer_type, fs.customer_key
"""
TARGET_COLUMNS = ['year', 'quarter', 'month', 'customer_type', 'customer_key', 'total_quantity', 'total_amount']
TARGET_TABLE   = 'olap_sales_time_customer'
