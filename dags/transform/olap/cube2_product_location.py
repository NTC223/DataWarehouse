# Cuboid: olap_inv_product_location
EXTRACT_SQL = """\
SELECT
    fi.product_key,
    dl.state,
...
GROUP BY fi.product_key, dl.state, dl.city
"""
TARGET_COLUMNS = ['product_key', 'state', 'city', 'total_quantity_on_hand']
TARGET_TABLE   = 'olap_inv_product_location'
